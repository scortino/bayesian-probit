...
mc = m.fit(X, Y, return_chain=True, n_iter=2000, seed=SEED)
preds = m.predict(X)
trace_plot(mc, path="./images/trace_metropolis_noinfo_2000.png", replace=False, title_prefix="Metropolis - ")
dist_plot(mc, path="./images/dist_metropolis_noinfo_2000.png", replace=False, title_prefix="Metropolis - ")
...
dist_plot(mc, path="./images/dist_metropolis_highvar_2000.png", replace=False, title_prefix="Metropolis - ")
...
dist_plot(mc, path="./images/dist_metropolis_lowvar_2000.png", replace=False, title_prefix="Metropolis - ")
